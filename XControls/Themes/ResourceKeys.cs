...
namespace XControls.Themes
{
  public static class ResourceKeys
  {
    ...
    public static readonly ComponentResourceKey ChromeButtonStyleKey = new ComponentResourceKey(typeof(ResourceKeys), "ChromeButtonStyleKey");

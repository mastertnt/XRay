...
namespace XSerialization.Values
{
    ...
    /// </summary>
    public class NullValueSerializationContract : IXSerializationContract
    {
        /// <summary>
        ...
        {
            XElement lNullElement = new XElement(XConstants.NULL_TAG);
            pParentElement.Add(lNullElement);

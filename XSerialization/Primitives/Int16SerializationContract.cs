...
{
    /// <summary>
    /// This class defines a serialization contract for Int16.
    /// </summary>
    public class Int16SerializationContract : PrimitiveTypeSerializationContract<Int16>
    {
        /// <summary>
        ...
        public override object Read(object pObjectToInitialize, XElement pElement, IXSerializationContext pSerializationContext)
        {
            ...
            Int16 lValue = (Int16)(pObjectToInitialize);
            try
            {
                lValue = Convert.ToInt16(pElement.Value.Trim(), CultureInfo.InvariantCulture);
            }

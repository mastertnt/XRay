...
{
    /// <summary>
    /// This class defines a serialization contract for Byte.
    /// </summary>
    public class ByteSerializationContract : PrimitiveTypeSerializationContract<Byte>
    {
        /// <summary>
        ...
        public override object Read(object pObjectToInitialize, XElement pElement, IXSerializationContext pSerializationContext)
        {
            ...
            Byte lValue = (Byte)(pObjectToInitialize);
            try
            {
                lValue = Convert.ToByte(pElement.Value.Trim(), CultureInfo.InvariantCulture);
            }

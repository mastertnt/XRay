...
{
    /// <summary>
    /// This class defines a serialization contract for Char.
    /// </summary>
    public class CharSerializationContract : PrimitiveTypeSerializationContract<Char>
    {
        /// <summary>
        ...
        public override object Read(object pObjectToInitialize, XElement pElement, IXSerializationContext pSerializationContext)
        {
            ...
            Char lValue = (Char)(pObjectToInitialize);
            try
            {
                lValue = Convert.ToChar(pElement.Value.Trim(), CultureInfo.InvariantCulture);
            }

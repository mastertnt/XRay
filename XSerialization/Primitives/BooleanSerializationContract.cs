...
namespace XSerialization.Primitives
{
    ...
    /// </summary>
    public class BooleanSerializationContract : PrimitiveTypeSerializationContract<Boolean>
    {
        /// <summary>
        ...
        public override object Read(object pObjectToInitialize, XElement pElement, IXSerializationContext pSerializationContext)
        {
            ...
            Boolean lValue = (Boolean)(pObjectToInitialize);
            try
            {
                lValue = Convert.ToBoolean(pElement.Value.Trim(), CultureInfo.InvariantCulture);
            }

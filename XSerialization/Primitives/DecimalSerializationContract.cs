...
{
    /// <summary>
    /// This class defines a serialization contract for Decimal.
    /// </summary>
    public class DecimalSerializationContract : PrimitiveTypeSerializationContract<Decimal>
    {
        /// <summary>
        ...
        public override object Read(object pObjectToInitialize, XElement pElement, IXSerializationContext pSerializationContext)
        {
            ...
            Decimal lValue = (Decimal)(pObjectToInitialize);
            try
            {
                lValue = Convert.ToDecimal(pElement.Value.Trim(), CultureInfo.InvariantCulture);
            }

...
{
    /// <summary>
    /// This class defines a serialization contract for Float.
    /// </summary>
    public class SingleSerializationContract : PrimitiveTypeSerializationContract<Single>
    {
        /// <summary>
        ...
        public override object Read(object pObjectToInitialize, XElement pElement, IXSerializationContext pSerializationContext)
        {
            ...
            Single lValue = (Single)(pObjectToInitialize);
            try
            {
                lValue = Convert.ToSingle(pElement.Value.Trim(), CultureInfo.InvariantCulture);
            }
